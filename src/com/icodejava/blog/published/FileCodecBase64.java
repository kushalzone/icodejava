 ...
 * www.icodejava.com
 *
 * This class can be used to Base64 encode or Base64 decode a file.
 * It uses apache commons codec library. (Tested with commons -codec- 1.4.jar)
 */
...
public class FileCodecBase64 {
    ...
    public static void main(String args[]) throws Exception {
        ...
        /* Encode a pdf file and write the encoded output to a text file. */
        encode("C:/temp/something.pdf" , "c:/temp/something-encoded.txt" , IS_CHUNKED);

        /* Decode an encoded text file and write the decoded file to file system */
     ...
     */
    private static void encode(String sourceFile, String targetFile, boolean isChunked)
            throws Exception {
